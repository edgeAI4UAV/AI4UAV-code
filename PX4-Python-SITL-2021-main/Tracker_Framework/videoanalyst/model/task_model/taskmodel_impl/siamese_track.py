...
from Tracker_Framework.videoanalyst.model.common_opr.common_block import (conv_bn_relu,
                                                        xcorr_depthwise)
from Tracker_Framework.videoanalyst.model.module_base import ModuleBase
from Tracker_Framework.videoanalyst.model.task_model.taskmodel_base import (TRACK_TASKMODELS,
                                                          VOS_TASKMODELS)
...
class SiamTrack(ModuleBase):
    ...
    def __init__(self, backbone, head, loss=None):
        ...
        self._phase = "train"
        self.support_phases = ["train", "feature", "track", "freeze_track_fea"]
