...
from Tracker_Framework.videoanalyst.data.builder import get_config as get_data_cfg
from Tracker_Framework.videoanalyst.engine.tester.builder import get_config as get_tester_cfg
from Tracker_Framework.videoanalyst.engine.trainer.builder import get_config as get_trainer_cfg
from Tracker_Framework.videoanalyst.model.builder import get_config as get_model_cfg
from Tracker_Framework.videoanalyst.optim.builder import get_config as get_optim_cfg
from Tracker_Framework.videoanalyst.pipeline.builder import get_config as get_pipeline_cfg
...
def specify_task(cfg: CfgNode) -> (str, CfgNode):
    ...
    """
    # for task in task_list:
    #     if cfg['track']['exp_name'] != default_str:
    return 'track', cfg['track']
