...
def main(args):
    imgs_path = '/home/velere/Documents/EdgeAI4UAV/Human_Re_Identification/video_analyst-master/dataset/group3'
    annots_path = '/home/velere/Documents/EdgeAI4UAV/Human_Re_Identification/video_analyst-master/dataset/group3.txt'
    ...
    for orig_img, gt_bbox in frame_provider:
        ...
        confidence_score = pipeline.get_track_score()
