...
def export_siamfcpp_fea_trt(task_cfg, parsed_args):
    ...
    model_trt = torch2trt(model, [x], use_onnx=False, max_workspace_size=1 << 5, fp16_mode=False, int8_mode=False,
...
def export_siamfcpp_track_fea_trt(task_cfg, parsed_args):
    ...
    model_trt = torch2trt(model, [search_im], use_onnx=False, max_workspace_size=1 << 5,
                          fp16_mode=False, int8_mode=False,
                          # opt_shape_param=opt_shape_param,
                          min_shapes=[(1, 3, 303, 303)],
                          max_shapes=[(1, 3, 512, 512)],
...
if __name__ == '__main__':
    parser = {
        'config': '/home/user/Downloads/PX4-Python-SITL-2021-main/Tracker_Framework/siamfcpp_vot_config/siamfcpp_googlenet_votlt.yaml',
        'output': 'siamfcpp_googlenet_vot_lt_ai4media_zedbox22'}
    parsed_args = parser
